...
public class MarsScrollView extends ScrollView {
	...
	public MarsScrollView(Context context) {
		super(context);
		this.mContext = context;
	}

	public MarsScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
	}

	public MarsScrollView(Context context, AttributeSet attrs, int defStyle) {
	...
	Handler resetPositionHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			if (scrollY != 0 && handleStop) {
				...
				this.sendEmptyMessageDelayed(0, eachDelay);
			}
		};
	};
