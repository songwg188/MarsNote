...
import com.mars.note.app.LoginActivity;
...
public class WidgetConfiguration extends Activity implements View.OnClickListener, SearchView.OnQueryTextListener {
	...
	private void relate() {
		...
		txt = (TextView) searchView.findViewById(this.getResources().getIdentifier("android:id/search_src_text", null, null));
		...
		onClickListener = new OnClickListener() {
			...
			public void onClick(View v) {
				if (v.getTag() != null) {
					...
					AlertDialogFactory.showAlertDialog(WidgetConfiguration.this, rootView,
							WidgetConfiguration.this.getString(R.string.widget_relate_to_others_dialog_message), new AlertDialogFactory.DialogPositiveListner() {

								@Override
								public void onClick(View arg0) {
									super.onClick(arg0);
									noteDBManager.addWidgetRelation(String.valueOf(appWidgetId), holder.id);
									Intent i2 = new Intent();
									i2.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, appWidgetId);
									setResult(Activity.RESULT_OK, i2);
									Intent intent = new Intent("com.mars.note.widget.relate");
	...
	private class SearchListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
								...
								if (path != null && (!path.equals("null")) && (!"".equals(path))) {
									if (Config.DB_SAVE_MODE) {
										...
										item.bm = PictureHelper.getCropImage(path,
												WidgetConfiguration.this.getResources().getDimension(R.dimen.listview_image_width), WidgetConfiguration.this
														.getResources().getDimension(R.dimen.listview_image_height), true, 100, WidgetConfiguration.this, 7,
												true);
									}
			...
			if (data != null) {
				...
				content = Util.filterContent(WidgetConfiguration.this, content, imageSpanInfoList);
			}
